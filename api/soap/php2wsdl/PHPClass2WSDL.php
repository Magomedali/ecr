...
class PHPClass2WSDL
{
     ...
     */
    public function __construct($class, $uri, $targetNamespace = null)
    {
    ...
    public function generateWSDL($withAnnotation = false)
    {
        ...
        $this->wsdl = new WSDL($qNameClassName, $this->targetNamespace, $this->xslUri);
